...
All of the above data (CO2, temperature, sea level, glacier volume, ice sheet area) prove that climate change is happening. We should try our best to prevent the deterioration of these conditions in order to protect the fragile ecosystems on which we depend.
